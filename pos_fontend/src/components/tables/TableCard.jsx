...
const TableCard = ({key, name,status, initials}) => {
    return (
        <div key={key} className='w-[350px] bg-white bg-opacity-15 backdrop-blur-sm border border-transparent hover:border-white p-5 rounded-lg border-white border-opacity-30 shadow-xl hover:shadow-lg transition-all cursor-pointer group'>
