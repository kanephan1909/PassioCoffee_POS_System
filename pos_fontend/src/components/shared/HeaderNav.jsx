...
const HeaderNav = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 p-5 h-[85px] flex justify-around border border-white border-opacity-30 shadow-xl" style={{ background: 'linear-gradient(135deg, #A6CE39 0%, #8BC34A 25%, #7CB342 50%, #689F38 75%, #558B2F 100%)' }}>
            <button
                onClick={() => {
                    navigate("/");
                    setActiveTab("home");
            ...
            <button onClick={() => navigate("/tables")} className="absolute bottom-8 rounded-full text-[#f5f5f5] p-3 items-center hover:bg-white hover:bg-opacity-10 border border-white border-opacity-30 shadow-lg bg-[#a6ce3986]"><CiCoffeeCup size={40}/> </button>
        </div>
    )
}
