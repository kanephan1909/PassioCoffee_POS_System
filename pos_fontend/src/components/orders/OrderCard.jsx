            ...
            <div className='flex items-center gap-5'>
                ...
                <div className='flex items-center justify-between w-[100%]'>
                    ...
                    <div className='flex flex-col items-end gap-2'>
                        ...
                        <p className='text-white opacity-80 text-sm'><FaCircle className='inline mr-1 text-green-600' />Sẵn Sàng Phục Vụ Món</p>
                    </div>
                </div>
            </div>
            <div className='flex justify-between items-center mt-4 text-white opacity-80'>
