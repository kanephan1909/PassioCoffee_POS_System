...
const OrderCard = () => {
    return (
        <div className='w-[420px] p-4 rounded-lg bg-white backdrop-blur-sm border order border-gray-200 shadow-xl hover:shadow-2xl transition-all cursor-pointer group'>
