...
const MiniCard = ({ title, icon, number, footerNum }) => {
  ...
  return (
    <div className='backdrop-blur-sm py-5 px-5 rounded-lg w-full md:w-[50%] border border-gray-200 shadow-xl hover:shadow-2xl transition-all cursor-pointer group bg-[#A6CE39]'>
      ...
      <div>
        ...
        <h1 className='text-[#f5f5f5] text-lg mt-2'>
          <span className='opacity-90'>{footerNum}%</span> hơn ngày hôm qua
        </h1>
      </div>
    </div>
  )
